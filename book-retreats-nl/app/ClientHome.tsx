...
// 1. We accepteren de data nu als een Prop, we fetchen het hier niet meer!
export default function ClientHome({ initialRetreatsEU, initialRetreatsNL }: { initialRetreatsEU: Retreat[]; initialRetreatsNL: Retreat[] }) {

  // 2. We zetten de binnengekomen data direct in de state (of gebruiken het rechtstreeks)
  ...
  const [locationFilter, setLocationFilter] = useState<'europe' | 'nl'>('europe');
  ...
  // Vanaf hier is het EXACT jouw return (...) block!
  return (
